...
public class Question implements Comparable<Question>, Serializable {
	...
	public Question(int questionId, String questionString, String category, int marks, String option1, String option2,
			String option3, String option4, String correctAnswers) {
		super();
	...
	public String toString() {
		return "Question [questionId=" + questionId + ", questionString=" + questionString + ", category=" + category
				...
				+ ", option4=" + option4 + ", correctAnswers=" + correctAnswers + "]";
	}

	@Override
	public int hashCode() {
		return Objects.hash(category, correctAnswers, marks, option1, option2, option3, option4, questionId,
				questionString);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(category, other.category) && Objects.equals(correctAnswers, other.correctAnswers)
	...
	public int compareTo(Question q) {
		...
		return this.getQuestionId() - q.getQuestionId();
	}
